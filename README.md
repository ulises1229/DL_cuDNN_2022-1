...
| 4.              |Redes Neuronales Recurrentes          | Series, dependencias de corto y largo plazo |   <ul> <li>[RNN](code/cudnn_samples_v8/RNN/RNN_example.cu)</li> <li></li> <li></li> </ul>    |  <ul> <li> <li> </li></ul>
